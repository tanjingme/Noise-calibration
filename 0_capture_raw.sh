...
#set DARK=True in config/IMX623.yaml when you capture bias frame
python scripts/prepare_cam_raw.py -config config/IMX623.yaml
#set DARK=False in config/IMX623.yaml  when you capture plain frame
# python scripts/prepare_cam_raw.py -config config/IMX623.yaml
# #still frame or moving frame
# python scripts/save_frame.py -config config/IMX623.yaml
